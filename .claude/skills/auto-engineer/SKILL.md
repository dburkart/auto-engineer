...
```sh
# No build command — this is a template/skill-only project
# No test command — this is a template/skill-only project
```
...
|---|---|---|
| format / lint check | (none — no formatter configured) | (none) |
| lint check | (none — no linter configured) | (none) |
